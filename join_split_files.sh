...
cat system/system/priv-app/MiuiCamera/oat/arm64/MiuiCamera.odex.* 2>/dev/null >> system/system/priv-app/MiuiCamera/oat/arm64/MiuiCamera.odex
rm -f system/system/priv-app/MiuiCamera/oat/arm64/MiuiCamera.odex.* 2>/dev/null
...
cat system/system/app/Opera/Opera.apk.* 2>/dev/null >> system/system/app/Opera/Opera.apk
rm -f system/system/app/Opera/Opera.apk.* 2>/dev/null
